						...
						<form action="" method="post">
							...
							<table>
								...
								<tr>
									...
									<td>
										<input type="text" name="query" placeholder="Përdoruesin ose Email-in" value="%"/>
									</td>
									<td> 
							...
							<div class="table-wrapper">
								...
								/*	if (!empty($_REQUEST['term'])) {
									...
									while($rreshti = mysqli_fetch_array($sql)) { 		
											...
											echo "<td><a href=\"fshij_perdorues.php?ID_Perdoruesi=$rreshti[ID_Perdoruesi]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\" class='button primary'>Fshij</a></td></tr>";
