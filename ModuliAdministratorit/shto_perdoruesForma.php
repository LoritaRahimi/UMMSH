							...
							<form method="post" action="shto_perdorues.php">
								<div class="row gtr-uniform">
									<div class="col-6 col-12-xsmall">
										<input type="text" name="Perdoruesi" id="Perdoruesi" value="" placeholder="Përdoruesi" /> <br>
										<input type="text" name="Fjalekalimi" id="Fjalekalimi" value="" placeholder="Fjalëkalimi" /> <br>
